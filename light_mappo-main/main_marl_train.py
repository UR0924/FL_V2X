...
with g.as_default():
    ...
    sta1 = tf.assign(w_1_p, w_1)
    sta2 = tf.assign(w_2_p, w_2)
    sta3 = tf.assign(w_3_p, w_3)
    sta4 = tf.assign(w_4_p, w_4)

    sta5 = tf.assign(b_1_p, b_1)
    sta6 = tf.assign(b_2_p, b_2)
    sta7 = tf.assign(b_3_p, b_3)
    sta8 = tf.assign(b_4_p, b_4)
...
def update_target_q_network(sess):
    ...
    sess.run([sta1,sta2,sta3,sta4,sta5,sta6,sta7,sta8])
