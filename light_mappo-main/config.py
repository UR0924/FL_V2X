...
def get_config():
    ...
    # env parameters
    parser.add_argument("--env_name", type=str, default='FL-V2X', help="specify the name of environment")
    ...
    # pretrained parameters
    parser.add_argument("--model_dir", type=str, default="E:/v16-1000/models", help="by default None. set the path to pretrained model.")
    # "D:/chrome/light_mappo-main/results/FL-V2X/MyEnv/mappo/check/run2/models"
